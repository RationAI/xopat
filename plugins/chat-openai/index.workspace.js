addPlugin("chat-openai", class extends XOpatPlugin {
    constructor(id) {
        super(id);
    }
    ...
    async pluginReady() {
        ...
        // provider until a manual reload. The shared helper bounds each attempt
        // (15s RPC timeout, not the 30s client backstop), retries with backoff, and
