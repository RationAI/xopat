        ...
        init: function(options) {
            return this.each(function() {
                ...
                that.$skip_btn = $("<div>", { class: that.cl.skip_btn })
                    .appendTo(that.enjoyhint)
                    .html("<span class='material-icons' style='color: white;font-size: xx-large;'>close</span>")
                    .click(function(e) {
                        that.hide();
                ...
                that.renderLabelWithShape = function(data, customBtnProps) {
                    ...
                    switch(label_hor_side) {
                        ...
                        case 'oversized':
                            setTimeout(function(){
                                ...
                                $('.enjoyhint_next_btn').css('color', 'black');
                                $('.enjoyhint_prev_btn').css('color', 'black');
                                $('.enjoyhint_close_btn').css('color', 'black');
                            }, 450)
                            label_y = central_ver_position
                            label_x = central_position;
                            break;
                    ...
                    setTimeout(function(){
                        ...
                        var ver_button_position = label_y - 30;
