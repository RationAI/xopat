...
| `webGlPrecision` | string | `"unorm8"` | First-pass render target precision: `"unorm8"` \| `"auto"` \| `"float16"`. `"auto"` lets float slides (16-bit/floating-point TIFF) render unquantized; the offscreen colour array doubles.                                                                       |
