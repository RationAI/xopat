...
digital pathology. It is server-agnostic, modular, and extensible through
plugins and modules.
...
:::info
Parts of this documentation are being migrated and modernized. If you find an
outdated section, please [open an issue](https://github.com/RationAI/xopat/issues).
:::
