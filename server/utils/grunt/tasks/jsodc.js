module.exports = function(grunt) {
    return function (file) {
        const config = require(grunt.util.getPath(file || 'docs/openseadragon.conf.js'));
        ...
        const result = grunt.util.execAtPath('node_modules/.bin/jsdoc', `-c ${grunt.util.getPath("docs/build/docs.conf.json", true)} --verbose`);
