...
class MultiPanelMenu extends BaseComponent {
...
{id: "s1", icon: settingsIcon, title: "Content1", body: "Settings1", class: ui.MultiPanelMenuTab},
{id: "s2", icon: settingsIcon, title: "Content2", body: "Settings2", class: ui.MultiPanelMenuTab},
{id: "s3", icon: settingsIcon, title: "Content3", body: "Settings3", class: ui.MultiPanelMenuTab},)
